defmodule TraderXWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(TraderXWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(TraderXWeb.Gettext, "errors", msg, opts)
    # end
